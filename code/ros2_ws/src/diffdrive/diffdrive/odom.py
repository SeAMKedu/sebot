...
# Varmistetaan, että encoder-niminen moduuli löytyy, 
# vaikka ROS2 pakettia ei olisi "sourcetettu" eli ympäristöön ei olisi asetettu tarvittavia polkuja ja ympäristömuuttujia.
try:
